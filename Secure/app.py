...
# Function to connect to the encrypted DB
def connect_to_encrypted_db(db_path, encryption_key):
...
def get_quote():
    try:
        ...
        return jsonify({"tdx_quote": quote_b64})
...
if __name__ == "__main__":
    ...
    db_connection = connect_to_encrypted_db('fithealth.db', encryption_key)
